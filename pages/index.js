  ...
  return (
    <Container
      ...
      <Box
        ...
        <Image
          src="https://img.icons8.com/plasticine/200/000000/github.png" alt="" />
        <form
          onSubmit={handleSearch}>
          <InputGroup>
            <InputLeftElement
              pointerEvents='none'
              children={<Image src="https://img.icons8.com/android/48/000000/search.png" boxSize={'20px'} alt="" />}
            />
            <Input
              type='text'
              value={text}
              onChange={(e) => handleChange(e.target.value)}
              placeholder='Find a user' variant={'outlined'} />
          </InputGroup>
          {!hide && (
            <Container
              position={'absolute'}
